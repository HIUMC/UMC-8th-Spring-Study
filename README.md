...
* ```git init``` // 저장소 생성
* ```git remote add origin https://github.com/HIUMC/UMC-8th-Spring-Study.git```  //저장소 내 컴퓨터 <-> 원격 연결
...
### 🏡 작업공간 생성
* UMC-8th-Spring-Study (프로젝트 루트 디렉토리)
...
* push를 완료했다면 스터디 repository에서 pull request를 진행합니다
    * 링크: https://github.com/HIUMC/UMC-8th-Spring-Study/pulls
