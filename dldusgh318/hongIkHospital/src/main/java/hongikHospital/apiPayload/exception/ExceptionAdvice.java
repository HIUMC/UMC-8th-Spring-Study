...
import hongikHospital.apiPayload.ApiResponse;
import hongikHospital.apiPayload.code.ErrorReasonDTO;
import hongikHospital.apiPayload.code.status.ErrorStatus;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> exception(Exception e, WebRequest request){
        ...
        return handleExceptionInternalFalse(e,ErrorStatus._INTERNAL_SERVER_ERROR, HttpHeaders.EMPTY, ErrorStatus._INTERNAL_SERVER_ERROR.getStatus(),request,e.getMessage());
    }
